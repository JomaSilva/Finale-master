		...
		Research_Station
			...
			verb/Experiment()
				...
				for(var/obj/items/Material/A in usr.contents)
					studylist+=A
				if(studylist.len==0)
					to_chat(usr, "You have no materials to study!")
				else
						...
						switch(input(usr,"Craft which item?","","Cancel") in list("Enhancer","Cancel"))
							if("Enhancer")
								if(usr.zenni>=4000)
									...
									A.techcost+=4000
								else to_chat(usr, "You dont have enough money (You need 4,000 zenni to craft.)")
					if("Robotics")
						switch(input(usr,"Which type of robotics item?","","Cancel") in list("Modules","Cybernetic Limbs","Robotic Limbs","Weapons"))
							if("Modules")
								...
								if(A=="Solar Cell ([10000]z)")
									to_chat(usr, "This device is usually pre-installed in androids. Solar Cells are pretty shit, they only charge you up to 80% stamina.")
								...
								if(A=="Infinite Energy Core ([100000]z)")
									to_chat(usr, "An infinite energy core gives you just that, infinite energy. It can hold shittons of energy, and power you forever.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=100000
								...
								if(A=="Repair Core ([10000]z)")
									to_chat(usr, "Repair cores use energy to periodically heal you.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=10000
								...
								if(A=="Energy Core ([10000]z)")
									to_chat(usr, "A lower tier, fission powered micro-reactor capable of generating near-lifelike amounts of Ki.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=10000
								...
								if(A=="Metabolic Interchange ([15000]z)")
									to_chat(usr, "Rapid degradation of organic matter in the system for direct conversion into usable energy, in a compact package. Digestive apparatus not included.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=15000
								...
								if(A=="Metabolic Autonomer ([15000]z)")
									to_chat(usr, "Will automatically consume food in your inventory for a hefty energy pricetag. Will only activate at low stamina, and low nutrition. Will sometimes need to be maually reset (via body tab.)")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=15000
								...
								if(A=="Repair Nanobots ([95000]z)")
									to_chat(usr, "A fleet of tiny dormant robots. While activated they will flit about your body, repairing damage. Install in torso cavity.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=95000
								...
								if(A=="Rebreather Module ([10000]z)")
									to_chat(usr, "Many tanks of oxygen and a judicious application of capsule technology ensure you will never run out of air in inhospitable conditions. Install in torso cavity.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=10000
								...
								if(A=="Levitation Systems ([100000]z)")
									to_chat(usr, "Defy gravity for FREE*. Install in an artificial leg. *Note: Not actually free, uses energy from the module.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=100000
								...
								if(A=="Advanced Targeting Systems ([1000000]z)")
									to_chat(usr, "Enhance your sensory pathways with cybernetic technology, enabling a built-in set of scanning functions.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=1000000
								...
								if(A=="Hydraulic Force Multiplier ([1000000]z)")
									to_chat(usr, "Improve the force your muscles can output with advanced hydraulics originating from your abdomen. Requires artifical abdominal support to function. Also makes your body more fragile by exposing limbs to greater force transfer.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=1000000
								...
								if(A=="Forcefield Generator ([4000000]z)")
									to_chat(usr, "Generate a field that shields you from energy attacks. Requires energy for each deflection. Too much usage can overload the module, destroying it and the limb it is embedded within.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=4000000
								...
								if(A=="Matter Assimilator ([4000000]z)")
									to_chat(usr, "Deconstruct the matter of whomever you are grabbing, converting that matter into energy for yourself.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=4000000
								...
								if(A=="Limiter Overload ([1000000]z)")
									to_chat(usr, "Remove the limiters on your artificial limbs, greatly increasing your power at the cost of damaging your limbs and modules from the increased load. Installed in the torso.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=1000000
								...
								if(A=="Energy Capacitor ([100000]z)")
									to_chat(usr, "Convert the energy from ki-based attacks into usable energy for your body. WARNING: Module can overload if too much energy is absorbed, and will explode. Install in a hand.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=100000
								...
								if(A=="Reconstruction Core ([8000000]z)")
									to_chat(usr, "A microprocessor installed in an artificial brain that is connected to various systems. On destruction of vital body systems, will attempt to rebuild those systems using their scraps. Requires prolonged maintenance after usage.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=8000000
								...
								if(A=="Body Takeover Module ([8000000]z)")
									to_chat(usr, "The Body Takeover Module is a advanced module capable of letting the user take over a angered or knocked out opponent's body. However, their items, zenni, and skills are not usuable in this state. (Baby from GT's Module.)")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=8000000
							...
							if("Cybernetic Limbs")
								...
								if(A=="Cybernetic Torso Upgrade([100000]z)")
									to_chat(usr, "Enhance your organic musculature with mechanical upgrades. Comes at a small cost to ki-based abilities.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=100000
								...
								if(A=="Prosthetic Limb ([30000]z)")
									to_chat(usr, "Replace a lost limb with an inferior version. Reduces the limb's stats.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=30000
							...
							if("Weapons")
								...
								if(A=="Mega Buster([100000]z)")
									to_chat(usr, "An energy cannon that replaces the user's hand. Reduces the durability of that hand, but enables the user to fire blasts at a target.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=100000
								...
								if(A=="Rocket Punch([65000]z)")
									to_chat(usr, "A man's romance! No one is safe from your mighty fist. Reinforced to withstand the rigors of high speed collisions.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=65000
								...
								if(A=="Refractor Upgrade ([1000000]z)")
									to_chat(usr, "Install a refractor into your buster, enabling you to fire a concentrated beam of energy.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=1000000
								...
								if(A=="Abdominal Machinegun ([100000]z)")
									to_chat(usr, "German science is the greatest in the world! Installs a machinegun into your abdomen, allowing you to open fire!")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=100000
								...
								if(A=="Portable Missile Launcher ([500000]z)")
									to_chat(usr, "Install a portable homing missile system, complete with self-replenishing missiles.")
									var/B=input("Are you sure?") in list("Yes","No")
									switch(B)
										if("Yes")
											cost=500000
			...
			verb/Craft_Book()
				...
				else to_chat(usr, "You dont have enough money ([50*usr.techskill] zenni required.)")