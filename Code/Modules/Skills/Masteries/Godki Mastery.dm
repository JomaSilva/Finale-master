...
/datum/mastery
	Godki
		...
		levelstat()
			...
			if(level == 45)
				to_chat(savant, "You now can now master specializations of God Ki. Voce ganha [GODKI_POINTS_PER_MILESTONE] pontos a cada marco de MAESTRIA de God Ki (33/50/70/100%). Choose which one to focus on wisely.")
				...
				to_chat(savant, "As a reminder, usar o God Ki (em combate conta em dobro) aumenta sua MAESTRIA de God Ki.")
